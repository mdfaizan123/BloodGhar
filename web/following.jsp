...
<%
    HashMap hm=(HashMap)session.getAttribute("userDetails");
     if(hm!=null){
         java.util.ArrayList<java.util.HashMap> allFollowingDetails=(java.util.ArrayList)session.getAttribute("allFollowingDetails");
%>
<!doctype html>
<html lang="en">
...
<body>
    ...
    <div class="pjumbotron" style="background-color: white">
              <% if(allFollowingDetails!=null)   { %>
               <% for(HashMap fd:allFollowingDetails) { %>
